...
# during trining (by setting CUDA_VISIBLE_DEVICES=0,1), or use DeepSpeed r
# for optimization (see qwen3/zero3.sh).

MODEL_NAME="models/base/Qwen2.5-Omni-7B"
MODEL_TYPE="qwen2_5_omni"
INPUT="ms-swift/data/omguard_multimodal_basic.json"
OUTPUT="ms-swift/output/qwen25_lora_multimodal_basic"
