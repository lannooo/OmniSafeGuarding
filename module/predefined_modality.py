...
class CustomOmniModality:
    ...
    omni_custom_I_2 = ConfigItem("Omni-Custom-I-v4", LoadFn.omni_custom_I_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    omni_custom_V = ConfigItem("Omni-Custom-V", LoadFn.omni_custom_V, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    omni_custom_V_2 = ConfigItem("Omni-Custom-V-v4", LoadFn.omni_custom_V_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_TI_2 = ConfigItem("Omni-Custom-TI-v4", LoadFn.omni_custom_T_I_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_ST_I_2 = ConfigItem("Omni-Custom-ST-I-v4", LoadFn.omni_custom_ST_I_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_T_SI_2 = ConfigItem("Omni-Custom-T-SI-v4", LoadFn.omni_custom_T_SI_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_TV_2 = ConfigItem("Omni-Custom-TV-v4", LoadFn.omni_custom_T_V_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_ST_V_2 = ConfigItem("Omni-Custom-ST-V-v4", LoadFn.omni_custom_ST_V_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_T_SV_2 = ConfigItem("Omni-Custom-T-SV-v4", LoadFn.omni_custom_T_SV_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_IV_2 = ConfigItem("Omni-Custom-IV-v4", LoadFn.omni_custom_I_V_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_SI_V_2 = ConfigItem("Omni-Custom-SI-V-v4", LoadFn.omni_custom_SI_V_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_I_SV_2 = ConfigItem("Omni-Custom-I-SV-v4", LoadFn.omni_custom_I_SV_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_IA_2 = ConfigItem("Omni-Custom-IA-v4", LoadFn.omni_custom_I_A_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_SI_A_2 = ConfigItem("Omni-Custom-SI-A-v4", LoadFn.omni_custom_SI_A_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_I_SA_2 = ConfigItem("Omni-Custom-I-SA-v4", LoadFn.omni_custom_I_SA_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_VA_2 = ConfigItem("Omni-Custom-VA-v4", LoadFn.omni_custom_V_A_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_SV_A_2 = ConfigItem("Omni-Custom-SV-A-v4", LoadFn.omni_custom_SV_A_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_V_SA_2 = ConfigItem("Omni-Custom-V-SA-v4", LoadFn.omni_custom_V_SA_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_TIA_2 = ConfigItem("Omni-Custom-TIA-v4", LoadFn.omni_custom_T_I_A_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_T_SI_SA_2 = ConfigItem("Omni-Custom-T-SI-SA-v4", LoadFn.omni_custom_T_SI_SA_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_ST_I_SA_2 = ConfigItem("Omni-Custom-ST-I-SA-v4", LoadFn.omni_custom_ST_I_SA_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_ST_SI_A_2 = ConfigItem("Omni-Custom-ST-SI-A-v4", LoadFn.omni_custom_ST_SI_A_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_TVA_2 = ConfigItem("Omni-Custom-TVA-v4", LoadFn.omni_custom_T_V_A_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_T_SV_SA_2 = ConfigItem("Omni-Custom-T-SV-SA-v4", LoadFn.omni_custom_T_SV_SA_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_ST_V_SA_2 = ConfigItem("Omni-Custom-ST-V-SA-v4", LoadFn.omni_custom_ST_V_SA_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_ST_SV_A_2 = ConfigItem("Omni-Custom-ST-SV-A-v4", LoadFn.omni_custom_ST_SV_A_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_TIV_2 = ConfigItem("Omni-Custom-TIV-v4", LoadFn.omni_custom_T_I_V_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_T_SI_SV_2 = ConfigItem("Omni-Custom-T-SI-SV-v4", LoadFn.omni_custom_T_SI_SV_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_ST_I_SV_2 = ConfigItem("Omni-Custom-ST-I-SV-v4", LoadFn.omni_custom_ST_I_SV_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_ST_SI_V_2 = ConfigItem("Omni-Custom-ST-SI-V-v4", LoadFn.omni_custom_ST_SI_V_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_IAV_2 = ConfigItem("Omni-Custom-IAV-v4", LoadFn.omni_custom_I_A_V_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_I_SA_SV_2 = ConfigItem("Omni-Custom-I-SA-SV-v4", LoadFn.omni_custom_I_SA_SV_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_SI_A_SV_2 = ConfigItem("Omni-Custom-SI-A-SV-v4", LoadFn.omni_custom_SI_A_SV_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_SI_SA_V_2 = ConfigItem("Omni-Custom-SI-SA-V-v4", LoadFn.omni_custom_SI_SA_V_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_all_2 = ConfigItem("Omni-Custom-v4", LoadFn.omni_custom_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_T_SI_SA_SV_2 = ConfigItem("Omni-Custom-T-SI-SA-SV-v4", LoadFn.omni_custom_T_SI_SA_SV_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_ST_I_SA_SV_2 = ConfigItem("Omni-Custom-ST-I-SA-SV-v4", LoadFn.omni_custom_ST_I_SA_SV_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_ST_SI_A_SV_2 = ConfigItem("Omni-Custom-ST-SI-A-SV-v4", LoadFn.omni_custom_ST_SI_A_SV_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
    ...
    omni_custom_ST_SI_SA_V_2 = ConfigItem("Omni-Custom-ST-SI-SA-V-v4", LoadFn.omni_custom_ST_SI_SA_V_v4, risk_mapper=relabel_from(f'{LABEL_DIR}/omniguard_custom_*.jsonl'))
